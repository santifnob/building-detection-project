...
class ConvBlock(nn.Module):
    ...
    Arquitectura: Conv3x3 -> BN -> ReLU -> Conv3x3 -> BN (+ residual) -> ReLU
    """
...
class EncoderBlock(nn.Module):
    """Etapa de encoder: ConvBlock -> MaxPool2d -> Dropout2d opcional."""
...
class DecoderBlock(nn.Module):
    """Etapa de decoder: ConvTranspose2d (upsample) -> concat skip -> ConvBlock."""
    ...
    def forward(self, x: torch.Tensor, skip: torch.Tensor) -> torch.Tensor:
        ...
        # Padding para igualar tamaño con el skip-connection (dimensiones impares)
...
class UNet(nn.Module):
    """U-Net con bloques residuales para segmentación de edificios.

    Args:
        in_channels: Número de bandas de entrada (3 para RGB).
        num_classes: Número de clases (2 = fondo + edificio).
        base_features: Ancho del primer nivel del encoder.
        depth: Número de niveles de encoder/decoder.
        dropout: Probabilidad de spatial dropout en el encoder (usar 0.0 en inferencia).
    """
